...
class K34TeamResultsLambdaByClassTest {
    ...
    void runnersWhoRanTheDistanceTest() {
        // Given
        var k34_1 = new K34TeamResultsLambdaByClass(Optional.ofNullable(k34TeamScores1));
        var k34_2 = new K34TeamResultsLambdaByClass(Optional.ofNullable(k34TeamScores2));
